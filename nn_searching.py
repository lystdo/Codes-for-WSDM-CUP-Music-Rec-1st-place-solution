...
usr_features = ['bd', 'expiration_date', 'msno_source_screen_name_0', \
        ...
        'msno_source_screen_name_15', \
        'msno_source_screen_name_16', 'msno_source_screen_name_17', 'msno_source_screen_name_2', \
        'msno_source_screen_name_18', 'msno_source_screen_name_20', 'msno_source_screen_name_4', \
